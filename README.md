...
2. Не пройдена процедура авторизации - `status 401`
```
{
...
```
3. Не пройдена процедура авторизации - `status 401`
...
```
4. Данные переданы некорректно (возможный пример ответа) - `status 400` 
